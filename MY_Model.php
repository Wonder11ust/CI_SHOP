...
class MY_Model extends CI_Model 
{
   ...
   public function __construct()
   {
    ...
    if(!$this->table){ //jika nilai atribut table kosong/tidak ada,otomatis akan mencari nama kelas model diubah menjadi huruf kecil,menghapus _model
        $this->table = strtolower(
            str_replace('_model','',get_class($this)) //mereplace _model menjadi parameter kedua(kosong)
        );   
    }
   }
